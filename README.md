...
Manus和OpenManus 非常棒，但OpenManus目前暂无前端，于是本人花了2小时开发了基于Flask框架一个简单的WebUI,通过调用OpenManus实现前端调用。 🛫！

这是一个简洁的实现方案，前端页面需要不断的优化！优化点：
...
2. 克隆仓库：先进性安装OpenManus，后续安装OpenManusX的webUI就快的很
